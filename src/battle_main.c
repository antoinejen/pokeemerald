...
const struct TrainerMoney gTrainerMoneyTable[] =
{
    ...
    {TRAINER_CLASS_WINSTRATE, 12},
    {TRAINER_CLASS_PKMN_TRAINER_1, 50},
    {TRAINER_CLASS_PKMN_TRAINER_2, 50},
    {TRAINER_CLASS_RS_PROTAG, 50},
    {0xFF, 5}, // Any trainer class not listed above uses this
};

// This defines the type of ball used by each Trainer
const struct TrainerBall gTrainerBallTable[] = {
    {TRAINER_CLASS_TEAM_AQUA, ITEM_DIVE_BALL},
    {TRAINER_CLASS_AQUA_ADMIN, ITEM_DIVE_BALL},
    {TRAINER_CLASS_AQUA_LEADER, ITEM_DIVE_BALL},
    ...
    {TRAINER_CLASS_CAMPER, ITEM_POKE_BALL},
    ...
    {TRAINER_CLASS_TWINS, ITEM_NEST_BALL},
    ...
    {TRAINER_CLASS_RS_PROTAG, ITEM_POKE_BALL},
    {0xFF, ITEM_POKE_BALL},
};
