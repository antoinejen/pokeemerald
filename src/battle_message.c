...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] =
{
    ...
    [STRINGID_ITISTHUNDERING - BATTLESTRINGS_TABLE_START] = sText_ItIsThundering,
    [STRINGID_THUNDERCONTINUES - BATTLESTRINGS_TABLE_START] = sText_ThunderContinues,
};
...
static const u8 sATypeMove_Table[NUMBER_OF_MON_TYPES][19] =
{
