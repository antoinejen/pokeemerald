...
{
    { MAP_NUM(ROUTE103), MAP_NUM(ROUTE110), MAP_NUM(ROUTE115), MAP_NUM(ROUTE117), MAP_NUM(ROUTE118) , ___ },
    ...
    { MAP_NUM(ROUTE112), MAP_NUM(ROUTE113), MAP_NUM(JAGGED_PASS), MAP_NUM(FIERY_PATH), ___, ___ },
    ...
    { MAP_NUM(ROUTE119), MAP_NUM(ROUTE120), MAP_NUM(ROUTE123), ___, ___, ___ },
