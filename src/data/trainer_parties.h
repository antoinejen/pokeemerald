...
static const struct TrainerMonNoItemCustomMoves sParty_Felix[] = {
    ...
    .lvl = 63,
    .species = SPECIES_CLAYDOL,
    .moves = {MOVE_SKILL_SWAP, MOVE_EARTHQUAKE, MOVE_COSMIC_POWER, MOVE_ANCIENT_POWER}
    },
    {
    .iv = 0,
    .lvl = 63,
    .species = SPECIES_DUSCLOPS,
    .moves = {MOVE_SHADOW_BALL, MOVE_CURSE, MOVE_WILL_O_WISP, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 0,
    .lvl = 63,
    .species = SPECIES_SALAMENCE,
    .moves = {MOVE_DRAGON_CLAW, MOVE_FLAMETHROWER, MOVE_CRUNCH, MOVE_FLY}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky2[] = {
    ...
    .lvl = 33,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_PIN_MISSILE, MOVE_SLASH, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky4[] = {
    ...
    .lvl = 43,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_BELLY_DRUM, MOVE_SLASH, MOVE_SURF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Ricky5[] = {
    ...
    .lvl = 50,
    .species = SPECIES_LINOONE,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_BELLY_DRUM, MOVE_SLASH, MOVE_SURF}
    },
    {
    .iv = 40,
    .lvl = 50,
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_SUPERPOWER, MOVE_BOUNCE, MOVE_SURF}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Randall[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_QUICK_ATTACK, MOVE_AGILITY, MOVE_AERIAL_ACE, MOVE_STEEL_WING}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Parker[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TEETER_DANCE, MOVE_DIZZY_PUNCH, MOVE_FOCUS_PUNCH, MOVE_PSYBEAM}
    },
    {
    .iv = 255,
    .lvl = 36,
    .species = SPECIES_LOUDRED,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SUPERSONIC, MOVE_STOMP, MOVE_UPROAR, MOVE_BITE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_SLASH, MOVE_COUNTER, MOVE_ENDURE}
    },
    {
    .iv = 255,
    .lvl = 36,
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FOCUS_ENERGY, MOVE_SLASH, MOVE_DETECT, MOVE_REVENGE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Braxton[] = {
    ...
    .lvl = 42,
    .species = SPECIES_SWELLOW,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_AERIAL_ACE, MOVE_AGILITY, MOVE_ENDEAVOR}
    },
    {
    .iv = 100,
    .lvl = 42,
    ...
    .lvl = 42,
    .species = SPECIES_WAILORD,
    .moves = {MOVE_AMNESIA, MOVE_WATER_SPOUT, MOVE_REST, MOVE_BODY_SLAM}
    },
    {
    .iv = 100,
    .lvl = 42,
    .species = SPECIES_MAGNETON,
    .moves = {MOVE_THUNDERBOLT, MOVE_LIGHT_SCREEN, MOVE_THUNDER_WAVE, MOVE_SWIFT}
    },
    {
    .iv = 100,
    .lvl = 42,
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = {
    ...
    .species = SPECIES_WIGGLYTUFF,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_DEFENSE_CURL, MOVE_DOUBLE_EDGE, MOVE_SHADOW_BALL, MOVE_HYPER_VOICE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Jody[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_CRUSH_CLAW, MOVE_DETECT}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Wendy[] = {
    ...
    .lvl = 43,
    .species = SPECIES_ROSELIA,
    .moves = {MOVE_GIGA_DRAIN, MOVE_PETAL_DANCE, MOVE_GRASS_WHISTLE, MOVE_TOXIC}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_FLY, MOVE_WATER_PULSE, MOVE_MIST, MOVE_PROTECT}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_RHYDON,
    .moves = {MOVE_TAKE_DOWN, MOVE_ROCK_BLAST, MOVE_STOMP, MOVE_SCARY_FACE}
    },
    {
    .iv = 100,
    .lvl = 43,
    .species = SPECIES_TROPIUS,
    .moves = {MOVE_SOLAR_BEAM, MOVE_STOMP, MOVE_MAGICAL_LEAF, MOVE_WHIRLWIND}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Daphne[] = {
    ...
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SWEET_KISS, MOVE_AGILITY, MOVE_HYDRO_PUMP}
    },
    {
    .iv = 100,
    .lvl = 64,
    .species = SPECIES_LUVDISC,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_ATTRACT, MOVE_SAFEGUARD, MOVE_TAKE_DOWN, MOVE_HYDRO_PUMP}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_BELLY_DRUM, MOVE_REST, MOVE_TAKE_DOWN, MOVE_SLASH}
    },
    {
    .iv = 40,
    .lvl = 44,
    .species = SPECIES_DELCATTY,
    .heldItem = ITEM_NUGGET,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_HEAL_BELL, MOVE_COVET, MOVE_CHARM}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Olivia[] = {
    ...
    .lvl = 60,
    .species = SPECIES_CRAWDAUNT,
    .moves = {MOVE_ENDEAVOR, MOVE_CRABHAMMER, MOVE_CRUNCH, MOVE_PROTECT}
    },
    {
    .iv = 100,
    .lvl = 62,
    .species = SPECIES_STARMIE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_RECOVER}
    },
    {
    .iv = 100,
    .lvl = 64,
    .species = SPECIES_LUDICOLO,
    .moves = {MOVE_HYDRO_PUMP, MOVE_RAIN_DANCE, MOVE_KNOCK_OFF, MOVE_GIGA_DRAIN}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_Jeffrey5[] = {
    {
    .iv = 40,
    .lvl = 57,
    .species = SPECIES_MASQUERAIN,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .species = SPECIES_MIGHTYENA,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_IRON_TAIL, MOVE_DOUBLE_EDGE, MOVE_SAND_ATTACK, MOVE_CRUNCH}
    },
    {
    .iv = 250,
    .lvl = 78,
    ...
    .species = SPECIES_SHIFTRY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_LEAF_BLADE, MOVE_DOUBLE_TEAM, MOVE_SWAGGER, MOVE_EXTRASENSORY}
    },
    {
    .iv = 255,
    .lvl = 78,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_FLAMETHROWER, MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB}
    },
    {
    .iv = 250,
    .lvl = 76,
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHADOW_BALL, MOVE_CONFUSE_RAY, MOVE_PAIN_SPLIT, MOVE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 81,
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AMNESIA, MOVE_BLIZZARD, MOVE_ENDURE, MOVE_EARTHQUAKE}
    },
    {
    .iv = 250,
    .lvl = 81,
    ...
    .moves = {MOVE_SAFEGUARD, MOVE_REST, MOVE_SURF, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 82,
    .species = SPECIES_CLOYSTER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EXPLOSION, MOVE_PROTECT, MOVE_HAIL, MOVE_ICE_BEAM}
    },
    {
    .iv = 250,
    .lvl = 82,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ATTRACT, MOVE_CONFUSE_RAY, MOVE_HAIL, MOVE_BLIZZARD}
    },
    {
    .iv = 255,
    .lvl = 83,
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_BEAM, MOVE_OUTRAGE, MOVE_THUNDER_PUNCH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 255,
    .lvl = 85,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FIRE_PUNCH, MOVE_SANDSTORM, MOVE_ROCK_POLISH, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 15,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TACKLE, MOVE_BIND, MOVE_CURSE, MOVE_ROCK_TOMB}
    },
    {
    .iv = 100,
    .lvl = 16,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_GUN, MOVE_ICY_WIND, MOVE_FLAIL, MOVE_ROCK_TOMB}
    },
    {
    .iv = 200,
    .lvl = 17,
    .species = SPECIES_NOSEPASS,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_BLOCK, MOVE_THUNDER_WAVE, MOVE_ICE_PUNCH, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_MACHOP,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_KARATE_CHOP, MOVE_KNOCK_OFF, MOVE_SEISMIC_TOSS, MOVE_BULK_UP}
    },
    {
    .iv = 100,
    .lvl = 22,
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_MACH_PUNCH, MOVE_HEADBUTT, MOVE_STUN_SPORE, MOVE_BULK_UP}
    },
    {
    .iv = 200,
    .lvl = 24,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson1[] = {
    ...
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SHOCK_WAVE, MOVE_BUBBLE_BEAM, MOVE_CONFUSE_RAY, MOVE_THUNDER_WAVE}
    },
    {
    .iv = 220,
    .lvl = 28,
    .species = SPECIES_MAGNETON,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TRI_ATTACK, MOVE_SHOCK_WAVE, MOVE_THUNDER_WAVE, MOVE_MAGNET_BOMB}
    },
    {
    .iv = 220,
    .lvl = 29,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PROTECT, MOVE_SHOCK_WAVE, MOVE_CONFUSE_RAY, MOVE_COUNTER}
    },
    {
    .iv = 250,
    .lvl = 30,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_ANCIENT_POWER, MOVE_LIGHT_SCREEN, MOVE_SUNNY_DAY}
    },
    {
    .iv = 200,
    .lvl = 37,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_SOLAR_BEAM, MOVE_BOUNCE, MOVE_AGILITY}
    },
    {
    .iv = 200,
    .lvl = 38,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_THUNDER_FANG, MOVE_FEINT_ATTACK, MOVE_ROAR}
    },
    {
    .iv = 250,
    .lvl = 39,
    .species = SPECIES_CAMERUPT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_AMNESIA, MOVE_SUNNY_DAY, MOVE_EARTH_POWER}
    },
    {
    .iv = 250,
    .lvl = 40,
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWORDS_DANCE, MOVE_SLASH, MOVE_FACADE, MOVE_CRUSH_CLAW}
    },
    {
    .iv = 200,
    .lvl = 45,
    ...
    .moves = {MOVE_OUTRAGE, MOVE_CRUNCH, MOVE_FACADE, MOVE_COUNTER}
    },
    {
    .iv = 200,
    .lvl = 46,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_BEAM, MOVE_FACADE, MOVE_CRUNCH, MOVE_SCREECH}
    },
    {
    .iv = 250,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_AGILITY, MOVE_ENDEAVOR, MOVE_DOUBLE_TEAM, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 52,
    .species = SPECIES_PELIPPER,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_SUPERSONIC, MOVE_PROTECT, MOVE_AERIAL_ACE}
    },
    {
    .iv = 210,
    .lvl = 53,
    ...
    .species = SPECIES_SKARMORY,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SAND_ATTACK, MOVE_SLASH, MOVE_STEEL_WING, MOVE_AERIAL_ACE}
    },
    {
    .iv = 220,
    .lvl = 55,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_FANG, MOVE_MEAN_LOOK, MOVE_CONFUSE_RAY, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_SLACK_OFF, MOVE_SURF}
    },
    {
    .iv = 250,
    .lvl = 61,
    .species = SPECIES_EXEGGUTOR,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EXTRASENSORY, MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER, MOVE_CALM_MIND}
    },
    {
    .iv = 250,
    .lvl = 62,
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .species = SPECIES_HUNTAIL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_CRUNCH, MOVE_SCREECH, MOVE_RAIN_DANCE}
    },
    {
    .iv = 200,
    .lvl = 65,
    .species = SPECIES_GOREBYSS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_PSYCHIC, MOVE_AMNESIA, MOVE_AGILITY}
    },
    {
    .iv = 200,
    .lvl = 66,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_HYPER_VOICE, MOVE_WATER_PULSE, MOVE_AMNESIA, MOVE_BOUNCE}
    },
    {
    .iv = 200,
    .lvl = 67,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WATER_PULSE, MOVE_PSYCHIC, MOVE_CONFUSE_RAY, MOVE_RECOVER}
    },
    {
    .iv = 200,
    .lvl = 68,
    .species = SPECIES_WALREIN,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SWAGGER, MOVE_BODY_SLAM, MOVE_ICE_BEAM, MOVE_WATER_PULSE}
    },
    {
    .iv = 250,
    .lvl = 69,
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .species = SPECIES_WAILORD,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_RAIN_DANCE, MOVE_WATER_SPOUT, MOVE_EARTHQUAKE, MOVE_BLIZZARD}
    },
    {
    .iv = 255,
    .lvl = 85,
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_TOXIC, MOVE_HYDRO_PUMP, MOVE_SLUDGE_WAVE, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 86,
    .species = SPECIES_LUDICOLO,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ENERGY_BALL, MOVE_SURF, MOVE_LEECH_SEED, MOVE_DOUBLE_TEAM}
    },
    {
    .iv = 255,
    .lvl = 86,
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EARTHQUAKE, MOVE_MUDDY_WATER, MOVE_FOCUS_BLAST, MOVE_ICE_BEAM}
    },
    {
    .iv = 255,
    .lvl = 86,
    .species = SPECIES_GYARADOS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_GIGA_IMPACT, MOVE_WATERFALL}
    },
    {
    .iv = 255,
    .lvl = 88,
...
static const struct TrainerMonNoItemCustomMoves sParty_Camden[] = {
    ...
    .lvl = 47,
    .species = SPECIES_STARMIE,
    .moves = {MOVE_PSYCHIC, MOVE_HYDRO_PUMP, MOVE_COSMIC_POWER, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 0,
    .lvl = 47,
...
static const struct TrainerMonNoItemCustomMoves sParty_Isaiah1[] = {
    {
    .iv = 0,
    .lvl = 50,
    .species = SPECIES_STARMIE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Pablo1[] = {
    {
    .iv = 0,
    .lvl = 47,
    .species = SPECIES_STARMIE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Isaiah2[] = {
    {
    .iv = 10,
    .lvl = 54,
    .species = SPECIES_STARMIE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Isaiah3[] = {
    {
    .iv = 20,
    .lvl = 58,
    .species = SPECIES_STARMIE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Isaiah4[] = {
    {
    .iv = 30,
    .lvl = 62,
    .species = SPECIES_STARMIE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Isaiah5[] = {
    {
    .iv = 40,
    .lvl = 66,
    .species = SPECIES_STARMIE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Talia[] = {
    {
    .iv = 0,
    .lvl = 54,
    .species = SPECIES_STARMIE,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao3[] = {
    ...
    .lvl = 35,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_TOXIC, MOVE_SMOKESCREEN, MOVE_SLUDGE_BOMB, MOVE_SELF_DESTRUCT}
    },
    {
    .iv = 20,
    .lvl = 35,
    ...
    .lvl = 35,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_TOXIC, MOVE_SMOKESCREEN, MOVE_SLUDGE_BOMB, MOVE_HAZE}
    },
    {
    .iv = 20,
    .lvl = 37,
...
static const struct TrainerMonNoItemCustomMoves sParty_Lao4[] = {
    ...
    .lvl = 43,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_TOXIC, MOVE_SMOKESCREEN, MOVE_SLUDGE_BOMB, MOVE_HEAT_WAVE}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline3[] = {
    ...
    .lvl = 40,
    .species = SPECIES_STARYU,
    .moves = {MOVE_BUBBLE_BEAM, MOVE_CONFUSE_RAY, MOVE_PSYBEAM, MOVE_RAIN_DANCE}
    },
    {
    .iv = 20,
    .lvl = 40,
    .species = SPECIES_SEALEO,
    .moves = {MOVE_AURORA_BEAM, MOVE_BODY_SLAM, MOVE_SWAGGER, MOVE_HAIL}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Madeline5[] = {
    ...
    .lvl = 48,
    .species = SPECIES_STARMIE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_CONFUSE_RAY, MOVE_PSYCHIC, MOVE_RAIN_DANCE}
    },
    {
    .iv = 40,
    .lvl = 48,
    .species = SPECIES_SEALEO,
    .moves = {MOVE_BLIZZARD, MOVE_BODY_SLAM, MOVE_SWAGGER, MOVE_HAIL}
    },
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Becky[] = {
    ...
    .lvl = 32,
    .species = SPECIES_SANDSLASH,
    .moves = {MOVE_SWIFT, MOVE_POISON_STING, MOVE_SLASH, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 32,
    .species = SPECIES_AZUMARILL,
    .moves = {MOVE_ROLLOUT, MOVE_BUBBLE_BEAM, MOVE_BOUNCE, MOVE_BOUNCE}
    },
    {
    .iv = 0,
    .lvl = 32,
    ...
    .moves = {MOVE_SLAM, MOVE_SPARK, MOVE_DOUBLE_KICK, MOVE_DOUBLE_TEAM}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Marley[] = {
    ...
    .species = SPECIES_MANECTRIC,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BITE, MOVE_CHARGE, MOVE_THUNDER_WAVE, MOVE_THUNDERBOLT}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .lvl = 64,
    .species = SPECIES_FLYGON,
    .moves = {MOVE_FLY, MOVE_EARTHQUAKE, MOVE_DRAGON_BREATH, MOVE_HYPER_BEAM}
    },
    {
    .iv = 250,
    .lvl = 65,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_HYPNOSIS}
    }
};
...
static const struct TrainerMonNoItemDefaultMoves sParty_CourtneyJaggedPass[] = {
    {
    .iv = 50,
    .lvl = 29,
    .species = SPECIES_MIGHTYENA,
...
static const struct TrainerMonNoItemCustomMoves sParty_Isabella[] = {
    {
    .iv = 0,
    .lvl = 48,
    .species = SPECIES_STARMIE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_PSYCHIC, MOVE_CONFUSE_RAY, MOVE_SHADOW_BALL}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyRoute118[] = {
    {
    .iv = 150,
    .lvl = 40,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_TAKE_DOWN, MOVE_SAFEGUARD, MOVE_DRAGON_BREATH, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 150,
    .lvl = 39,
    ...
    .lvl = 42,
    .species = SPECIES_GARDEVOIR,
    .moves = {MOVE_DOUBLE_TEAM, MOVE_CALM_MIND, MOVE_PSYCHIC, MOVE_MAGICAL_LEAF}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Hideo[] = {
    ...
    .lvl = 38,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_TACKLE, MOVE_SELF_DESTRUCT, MOVE_SLUDGE_BOMB, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 38,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_TACKLE, MOVE_POISON_GAS, MOVE_SLUDGE_BOMB, MOVE_SMOKESCREEN}
    }
};
...
static const struct TrainerMonNoItemCustomMoves sParty_Keigo[] = {
    ...
    .lvl = 42,
    .species = SPECIES_WEEZING,
    .moves = {MOVE_POISON_GAS, MOVE_SELF_DESTRUCT, MOVE_SLUDGE_BOMB, MOVE_SMOKESCREEN}
    },
    {
    .iv = 0,
    .lvl = 42,
    .species = SPECIES_NINJASK,
    .moves = {MOVE_SAND_ATTACK, MOVE_DOUBLE_TEAM, MOVE_SLASH, MOVE_SWORDS_DANCE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    ...
    .lvl = 68,
    .species = SPECIES_FLYGON,
    .moves = {MOVE_FLY, MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_HYPER_BEAM}
    },
    {
    .iv = 250,
    .lvl = 69,
...
static const struct TrainerMonNoItemCustomMoves sParty_KimAndIris[] = {
    ...
    .lvl = 48,
    .species = SPECIES_ALTARIA,
    .moves = {MOVE_DRAGON_DANCE, MOVE_DRAGON_BREATH, MOVE_SAFEGUARD, MOVE_AERIAL_ACE}
    },
    {
    .iv = 0,
    .lvl = 49,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = {
    ...
    .species = SPECIES_RELICANTH,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_AMNESIA, MOVE_YAWN, MOVE_HYDRO_PUMP, MOVE_ROCK_SLIDE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = {
    ...
    .species = SPECIES_MEDITITE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_LIGHT_SCREEN, MOVE_REFLECT, MOVE_THUNDER_PUNCH}
    },
    {
    .iv = 255,
    .lvl = 41,
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SKY_UPPERCUT, MOVE_COUNTER, MOVE_BRICK_BREAK, MOVE_HEADBUTT}
    },
    {
    .iv = 255,
    .lvl = 43,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly3[] = {
    ...
    .species = SPECIES_HERACROSS,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_BRICK_BREAK, MOVE_MEGAHORN, MOVE_AERIAL_ACE, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson2[] = {
    ...
    .species = SPECIES_RAICHU,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_THUNDERBOLT, MOVE_AGILITY, MOVE_MEGA_PUNCH, MOVE_IRON_TAIL}
    },
    {
    .iv = 255,
    .lvl = 47,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = {
    ...
    .species = SPECIES_NINETALES,
    .heldItem = ITEM_WHITE_HERB,
    .moves = {MOVE_OVERHEAT, MOVE_EXTRASENSORY, MOVE_SAFEGUARD, MOVE_GRUDGE}
    },
    {
    .iv = 255,
    .lvl = 48,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = {
    ...
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_EXTREME_SPEED, MOVE_FLAMETHROWER, MOVE_AGILITY, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 51,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery4[] = {
    ...
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROAR, MOVE_SOLAR_BEAM, MOVE_FLAMETHROWER, MOVE_SUNNY_DAY}
    },
    {
    .iv = 255,
    .lvl = 56,
...
static const struct TrainerMonItemCustomMoves sParty_Norman2[] = {
    ...
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_HYPER_BEAM, MOVE_HYPER_VOICE, MOVE_CRUNCH, MOVE_FIRE_BLAST}
    },
    {
    .iv = 255,
    .lvl = 54,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_BELLY_DRUM, MOVE_REST, MOVE_SLASH, MOVE_FACADE}
    },
    {
    .iv = 255,
    .lvl = 55,
...
static const struct TrainerMonItemCustomMoves sParty_Norman3[] = {
    ...
    .species = SPECIES_KANGASKHAN,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_FAKE_OUT, MOVE_DIZZY_PUNCH, MOVE_MEGA_PUNCH, MOVE_OUTRAGE}
    },
    {
    .iv = 255,
    .lvl = 60,
...
static const struct TrainerMonItemCustomMoves sParty_Winona2[] = {
    ...
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_POISON_FANG, MOVE_CONFUSE_RAY, MOVE_DOUBLE_TEAM, MOVE_AERIAL_ACE}
    },
    {
    .iv = 255,
    .lvl = 59,
...
static const struct TrainerMonNoItemCustomMoves sParty_Pablo2[] = {
    {
    .iv = 10,
    .lvl = 51,
    .species = SPECIES_STARMIE,
    .moves = {MOVE_HYDRO_PUMP, MOVE_PSYCHIC, MOVE_COSMIC_POWER, MOVE_CONFUSE_RAY}
    },
    {
    .iv = 10,
    .lvl = 51,
...
static const struct TrainerMonNoItemCustomMoves sParty_Pablo3[] = {
    {
    .iv = 20,
    .lvl = 55,
    .species = SPECIES_PELIPPER,
    .moves = {MOVE_HYDRO_PUMP, MOVE_SPIT_UP, MOVE_SWALLOW, MOVE_STOCKPILE}
    },
    {
    .iv = 20,
    .lvl = 55,
...
static const struct TrainerMonNoItemCustomMoves sParty_Pablo4[] = {
    {
    .iv = 30,
    .lvl = 59,
    .species = SPECIES_PELIPPER,
...
static const struct TrainerMonItemCustomMoves sParty_Red[] = {
    ...
    .moves = {MOVE_VOLT_TACKLE, MOVE_IRON_TAIL, MOVE_EXTREME_SPEED, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_BODY_SLAM, MOVE_HYDRO_PUMP, MOVE_BLIZZARD, TYPE_PSYCHIC}
    },
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_REST, MOVE_CRUNCH, MOVE_HYPER_BEAM, MOVE_ROCK_SLIDE}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_PSYCHIC, MOVE_SELF_DESTRUCT, MOVE_CALM_MIND, MOVE_THUNDER}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .moves = {MOVE_BLAST_BURN, MOVE_AIR_SLASH, MOVE_HIDDEN_POWER, MOVE_EARTHQUAKE}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Leaf[] = {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_BODY_SLAM, MOVE_SHADOW_BALL, MOVE_METEOR_MASH, MOVE_FIRE_BLAST}
    },
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_GENGAR,
    .heldItem = ITEM_LEFTOVERS,
    .moves = {MOVE_EXPLOSION, MOVE_WILL_O_WISP, MOVE_ICE_PUNCH, MOVE_HYPNOSIS}
    },
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_DEWGONG,
    .heldItem = ITEM_CHESTO_BERRY,
    .moves = {MOVE_ICE_BEAM, MOVE_TOXIC, MOVE_REST, MOVE_SURF}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_FRENZY_PLANT, MOVE_SYNTHESIS, MOVE_SLUDGE_BOMB, MOVE_SLEEP_POWDER}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Blue[] = {
    ...
    .species = SPECIES_PIDGEOT,
    .heldItem = ITEM_SILK_SCARF,
    .moves = {MOVE_DOUBLE_EDGE, MOVE_AERIAL_ACE, MOVE_SUBSTITUTE, MOVE_QUICK_ATTACK}
    },
    {
    .iv = 255,
    .lvl = 100,
    ...
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_LUM_BERRY,
    .moves = {MOVE_FLARE_BLITZ, MOVE_EXTREME_SPEED, MOVE_SUNNY_DAY, MOVE_OVERHEAT}
    },
    {
    .iv = 255,
    .lvl = 100,
    .species = SPECIES_EXEGGUTOR,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_SUBSTITUTE, MOVE_GIGA_DRAIN, MOVE_LEECH_SEED, MOVE_EXPLOSION}
    },
    {
    .iv = 255,
    .lvl = 100,
...
static const struct TrainerMonItemDefaultMoves sParty_MayLavaridgeMudkip[] = {
    {
    .iv = 75,
    .lvl = 33,
    .species = SPECIES_SLUGMA,
...
static const struct TrainerMonItemDefaultMoves sParty_MayLavaridgeTorchic[] = {
    {
    .iv = 75,
    .lvl = 33,
    .species = SPECIES_LOMBRE,
...
static const struct TrainerMonItemDefaultMoves sParty_MayLavaridgeTreecko[] = {
    {
    .iv = 75,
    .lvl = 33,
    .species = SPECIES_PELIPPER,
...
static const struct TrainerMonItemDefaultMoves sParty_BrendanLavaridgeMudkip[] = {
    {
    .iv = 75,
    .lvl = 33,
    .species = SPECIES_SLUGMA,
...
static const struct TrainerMonItemDefaultMoves sParty_BrendanLavaridgeTorchic[] = {
    {
    .iv = 75,
    .lvl = 33,
    .species = SPECIES_LOMBRE,
...
static const struct TrainerMonItemDefaultMoves sParty_BrendanLavaridgeTreecko[] = {
    {
    .iv = 75,
    .lvl = 33,
    .species = SPECIES_PELIPPER,
...
static const struct TrainerMonNoItemDefaultMoves sParty_ArchieSlateportMuseum[] = {
    {
    .iv = 150,
    .lvl = 24,
    .species = SPECIES_GOLBAT,
