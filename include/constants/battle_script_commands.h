...
#define sEXP_CATCH                   (gBattleScripting + 0x0F) // expOnCatch
#define sTWOTURN_STRINGID            (gBattleScripting + 0x10) // twoTurnsMoveStringId
#define sB_ANIM_ARG1                 (gBattleScripting + 0x11) // animArg1
#define sB_ANIM_ARG2                 (gBattleScripting + 0x12) // animArg2
#define sTRIPLE_KICK_POWER           (gBattleScripting + 0x14) // tripleKickPower
#define sMOVEEND_STATE               (gBattleScripting + 0x15) // moveendState
#define sSAVED_STAT_CHANGER          (gBattleScripting + 0x16) // savedStatChanger
#define sSHIFT_SWITCHED              (gBattleScripting + 0x17) // shiftSwitched
#define sBATTLER                     (gBattleScripting + 0x18) // battler
#define sB_ANIM_TURN                 (gBattleScripting + 0x19) // animTurn
#define sB_ANIM_TARGETS_HIT          (gBattleScripting + 0x1A) // animTargetsHit
#define sSTATCHANGER                 (gBattleScripting + 0x1B) // statChanger
#define sSTAT_ANIM_PLAYED            (gBattleScripting + 0x1C) // statAnimPlayed
#define sGIVEEXP_STATE               (gBattleScripting + 0x1D) // getexpState
#define sBATTLE_STYLE                (gBattleScripting + 0x1E) // battleStyle
#define sLVLBOX_STATE                (gBattleScripting + 0x1F) // drawlvlupboxState
#define sLEARNMOVE_STATE             (gBattleScripting + 0x20) // learnMoveState
#define sSAVED_BATTLER               (gBattleScripting + 0x21) // savedBattler
#define sRESHOW_MAIN_STATE           (gBattleScripting + 0x22) // reshowMainState
#define sRESHOW_HELPER_STATE         (gBattleScripting + 0x23) // reshowHelperState
#define sLVLUP_HP                    (gBattleScripting + 0x24) // levelUpHP
#define sWINDOWS_TYPE                (gBattleScripting + 0x25) // windowsType
#define sMULTIPLAYER_ID              (gBattleScripting + 0x26) // multiplayerId
#define sSPECIAL_TRAINER_BATTLE_TYPE (gBattleScripting + 0x27) // specialTrainerBattleType
#define sMON_CAUGHT                  (gBattleScripting + 0x28) // monCaught
#define sSAVED_DMG                   (gBattleScripting + 0x2C) // savedDmg
#define sSAVED_MOVE_EFFECT           (gBattleScripting + 0x2E) // savedMoveEffect
#define sMOVE_EFFECT                 (gBattleScripting + 0x30) // moveEffect
#define sMULTIHIT_EFFECT             (gBattleScripting + 0x32) // multihitMoveEffect
#define sILLUSION_NICK_HACK          (gBattleScripting + 0x33) // illusionNickHack
#define sFIXED_ABILITY_POPUP         (gBattleScripting + 0x34) // fixedPopup
#define sABILITY_OVERWRITE           (gBattleScripting + 0x36) // abilityPopupOverwrite
